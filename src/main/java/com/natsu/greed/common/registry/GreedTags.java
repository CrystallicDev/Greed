...
public class GreedTags {
	...
	public static final TagKey<Structure> ON_BASTION_EXPLORER_MAPS = TagKey.create(Registry.STRUCTURE_REGISTRY, 
			new ResourceLocation(Greed.MODID, "bastion_explorer_maps"));
	public static final TagKey<Structure> ON_FORTRESS_EXPLORER_MAPS = TagKey.create(Registry.STRUCTURE_REGISTRY, 
			new ResourceLocation(Greed.MODID, "fortress_explorer_maps"));
	public static final TagKey<Structure> ON_END_CITY_EXPLORER_MAPS = TagKey.create(Registry.STRUCTURE_REGISTRY, 
			new ResourceLocation(Greed.MODID, "end_city_explorer_maps"));
	
	/*public static final TagKey<Structure> CARTOGRAPHER_STRUCTURE_LEVEL_2 = TagKey.create(Registry.STRUCTURE_REGISTRY, 
	...
	public static final TagKey<Structure> CARTOGRAPHER_STRUCTURE_LEVEL_3 = TagKey.create(Registry.STRUCTURE_REGISTRY, 
