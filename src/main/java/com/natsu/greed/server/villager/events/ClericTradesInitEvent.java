...
public class ClericTradesInitEvent {
	...
	public static void onTradeSetup(GreedFillingTradesEvent event) {
		...
		event.addTradeTo(ProfessionLevel.APPRENTICE, new VillagerTradeHandler.ItemsForEmeralds(Items.GLASS_BOTTLE, 4, 1, 32, 2));
		event.addTradeTo(ProfessionLevel.APPRENTICE, new VillagerTradeHandler.EmeraldForItems(Blocks.GLOWSTONE, 7, 12, 4));

		event.addTradeTo(ProfessionLevel.JOURNEYMAN, new VillagerTradeHandler.ItemsForEmeralds(Items.EXPERIENCE_BOTTLE, 2, 1, 30, 5));
		event.addTradeTo(ProfessionLevel.JOURNEYMAN, new PotionForEmeralds(10, List.of(new MobEffectInstance(MobEffects.REGENERATION, 30*20)), "item.greed.trade.regeneration", 10, 7));

		event.addTradeTo(ProfessionLevel.EXPERT, new PotionForEmeralds(12, List.of(new MobEffectInstance(MobEffects.HEAL)), "item.greed.trade.heal", 10, 15));
		event.addTradeTo(ProfessionLevel.EXPERT, new VillagerTradeHandler.ItemsForEmeralds(Items.GOLDEN_APPLE, 12, 1, 8, 10));
		...
		event.addTradeTo(ProfessionLevel.MASTER, new PotionForEmeralds(28, List.of(new MobEffectInstance(MobEffects.REGENERATION, 3*60*20), new MobEffectInstance(MobEffects.DAMAGE_BOOST, 3*60*20)), "item.greed.trade.heal_strength", 10, 3));
		event.addTradeTo(ProfessionLevel.MASTER, new PotionForEmeralds(16, List.of(new MobEffectInstance(MobEffects.DIG_SPEED, 3*60*20, 0)), "item.greed.trade.haste", 10, 3));
	...
	public static class PotionForEmeralds implements VillagerTrades.ItemListing {
		...
		public MerchantOffer getOffer(Entity entity, Random random) {
			...
			potion = PotionUtils.setPotion(potion, new Potion(effects.toArray(new MobEffectInstance[0])));
